...
def main():
    ...
    if submit_btn:
        ...
        cases_folder = Path(f"../../experiments/Rosenzweig_2011/fit_ravid/cases_highHydrol/CASES_{doc_val}mgDOC")
        template_folder = Path("../../experiments/Rosenzweig_2011/fit_ravid/cases_highHydrol/template")
        ...
        template_folder = Path("../../experiments/Rosenzweig_2011/fit_ravid/template")
        ...
        if cases_folder.exists():
            ...
            with mp.Pool() as pool:
                data = pool.starmap(
                    OpenFOAM.read_as_xarray_dataset,
                    [(of_low, group) for group in groups.values()],
                )
